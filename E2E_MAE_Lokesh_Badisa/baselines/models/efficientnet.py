...
def _efficientnet(
    ...
    model = EfficientNet(inverted_residual_setting, dropout, last_channel=last_channel,norm_layer=norm_layer)
...
def efficientnet_b0() -> EfficientNet:
    ...
    return _efficientnet(
        inverted_residual_setting, 0.2, last_channel
    )
...
def efficientnet_b2() -> EfficientNet:
    ...
    return _efficientnet(
        inverted_residual_setting, 0.3, last_channel
    )
...
def efficientnet_v2_s() -> EfficientNet:
...
def efficientnet_v2_m() -> EfficientNet:
...
def efficientnet_v2_l() -> EfficientNet:

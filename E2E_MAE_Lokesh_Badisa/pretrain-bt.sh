...
srun --export=ALL shifter python3 dist-training.py --runname after_deadline_bt --config small \
...
srun --export=ALL shifter python3 dist-sup-training.py --runname mae_ft_bt --model vit_small\
 ...
 ./Pretraining/vitmae/after_deadline_qg/best.pt --batch_size 128 --optim adamw --blr 1.5e-4

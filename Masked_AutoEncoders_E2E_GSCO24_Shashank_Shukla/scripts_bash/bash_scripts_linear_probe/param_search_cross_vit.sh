...
#SBATCH -J cross_vit_paramsearch_job     # Job name
...
srun torchrun --standalone --nproc_per_node=4 /global/homes/s/ssshukla/Shashank/scripts/LinearProbing/hyper_parameters.py \
                --epochs=10 \
                --batch_size=256 \
